...
// var f_btn = document.getElementsByTagName("aside").children;
// var nav_ul = document.getElementById('nav_bar_ul').children;
// var wrapBox = document.getElementById("wrapBox");
// var foot = document.getElementById("foot");
var arrow = document.getElementsByClassName("down_arrow");
// alert(arrow.length)
var bg = document.getElementsByClassName("box");
var boxs = document.getElementsByTagName("section");
// var indexs = 0;

var f_btn=document.getElementsByClassName("asi");
...
function btnChange(index,flag,speed){
    ...
    for(var n=0; n<f_btn.length;n++){
        f_btn[n].style.background = "#fff";
    }

    for(var n=0;n<nav_ul.length;n++){
        nav_ul[n].style.color = '#80d6f2';
    }

    if(flag){
        if(index <= 0 ){
            indexs = 0;
            f_btn[0].style.background = "#80d6f2";
            //wrapBox.style.top = "0";
            nav_ul[0].style.color = 'red';
            divMove(wrapBox,0,20*speed);
        }
        else if(index >0 && index <=4){
            f_btn[index].style.background = "#80d6f2";
            ...
            divMove(wrapBox,(-height * 4 - fh),20*speed);
            nav_ul[index].style.color = 'red';
        }
        else{
            indexs = 5;
        ...
        if(index <= 0 ){
            ...
            indexs = 5;
            wrapBox.style.top = (-height * 4 - fh) +"px";
            nav_ul[index].style.color = 'red';
        }
        else{
            indexs = 5;
